...
public class MainLayout extends AppLayout {
    ...
    private AppNav createNavigation() {
        ...
        nav.addItem(new AppNavItem("Peliculas", PeliculasView.class, "la la-file"));
        nav.addItem(new AppNavItem("Actores", ActoresView.class, "la la-file"));
        nav.addItem(new AppNavItem("Directores", DirectoresView.class, "la la-file"));
